...
test("getDomain URLs válidas", () => {
    ...
    expect(getDomain('https://g1.globo.com/economia/censo/noticia/2024/09/06/censo-brasil-tem-57-mil-pessoas-morando-em-tendas-e-barracas-e-19-mil-em-veiculos.ghtml')).toBe('g1.globo.com');
